...
public class CodeProperties {
    ...
    public static final String packageName = "com.qsq.auth"; //生成后的包名
//    public static final String tableName ="user_order";
    public static final String[] tableName ={"sys_user","sys_role","sys_user_role","sys_permissions","sys_role_permissions"};
